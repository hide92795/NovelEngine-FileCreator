...
/**
 * 多角形のフィギュアデータを保存するセーバーです。
 * 
 * @author hide92795
 */
public class FigureSaverPolygon implements FigureSaver {
	@Override
	public void save(Map<?, ?> map_f, Packer packer) throws Exception {
		packer.write(SaverFigure.FIGURE_POLYGON);
		Map<?, ?> apexes = (Map<?, ?>) map_f.get("Apexes");
		int num_apex = apexes.size();
		packer.write(num_apex);
